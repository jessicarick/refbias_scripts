...
push @jobarray, "/project/phylogenref/scripts/test_simphy_ExtREFs_070720.sh $sim $tree_height \n";
push @jobarray, "/project/phylogenref/scripts/test_simphy_IntREFs_070720.sh $sim $tree_height \n";
