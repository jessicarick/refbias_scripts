...
bwa mem ${reference_prefix}_sim${sim}.fa fastq_reads/sim${sim}/fastq/${ind}/${ind}_${sim}_read1.fq.gz fastq_reads/sim${sim}/fastq/${ind}/${ind}_${sim}_read2.fq.gz > aln_${ind}.sam
