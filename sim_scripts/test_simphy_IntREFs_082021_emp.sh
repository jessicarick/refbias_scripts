...
#################################
	...
	parallel --delay 1 --jobs 2  --line-buffer --env genes --env sim --env QUAL --env miss_list --env REF_PATH --env output_dir --env day --env tree_height --env int "bash ${REF_PATH}/sim_scripts/each_maf_emp.sh {}" ::: $maf_list ::: $miss_list
