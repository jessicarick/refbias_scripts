...
module load gcc miniconda3 r parallel openmpi raxml
...
cd $base
ls *.phylip | parallel -j 8 "raxmlHPC-PTHREADS -s {} -n {.} -m ASC_GTRCAT -f a -x 12345 -N 100 --asc-corr=lewis -p 12345 -T 2 -V"
